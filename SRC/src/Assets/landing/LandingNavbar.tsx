        ...
        <div className="flex items-center justify-between h-16 sm:h-18">
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm shadow-md shadow-blue-600/25 hover:shadow-lg hover:shadow-blue-600/35 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 group whitespace-nowrap"
            >
              <span className="tracking-tight">Platform Console</span>
        ...
        <div className="xl:hidden bg-white border-b border-slate-200 px-4 pt-2 pb-6 space-y-2 shadow-lg animate-fade-in">
          ...
          <div className="pt-3 border-t border-slate-100 flex flex-col gap-2">
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm shadow-md shadow-blue-600/25 active:bg-blue-800 transition-all"
            >
